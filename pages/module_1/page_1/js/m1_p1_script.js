  ...
  for (let n = 0; n < _pageData.sections.length; n++) {
    ...
    if (sectionCnt == 1) {
      ...
      $("#section-" + sectionCnt)
        ...
        .find(".content-bg")
        .append(
          '<button class="goback-btn"></button><div class="body"><div class="dummypatch"></div><div class="text-container">' +
            htmlObj +
      ...
      $(".box")
        ...
        .on("click mouseenter mouseleave", onClickHandler);
      $(".btn_info")
        .off("click mouseenter mouseleave")
        .on("click mouseenter mouseleave", onClickinfoHandler);
    }
    setCSS(sectionCnt);
...
function onClickHandler(evt) {
  ...
  var body = $("#section-" + sectionCnt)
    ...
    .find(".body");
  //var sectionArray = _pageData.sections[sectionCnt - 1].content.sectionArray;
  var jumpToPage = [2, 3]; // [Physical Map (page 10), Political Map (page 2)]
...
function withAudioSync() {
  ...
  _tweenTimeline.add(
    animateFadeIn(body.find(".text-container"), 0.5).play(),
    1,
  );
  _tweenTimeline.add(
    animateFadeIn(body.find(".text-container").find("p"), 0.5).play(),
    1.5,
  );
