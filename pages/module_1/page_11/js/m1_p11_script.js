...
function addSectionData() {
  ...
  for (let n = 0; n < _pageData.sections.length; n++) {
    ...
    if (sectionCnt == 1) {
      ...
      const layerIcons = {
        physical: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 17l4-8 4 5 3-4 4 7H3z"/><path d="M3 17h18"/></svg>`,
        rivers: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 8c2 0 4 2 8 2s6-2 8-2"/><path d="M4 13c2 0 4 2 8 2s6-2 8-2"/><path d="M4 18c2 0 4 2 8 2s6-2 8-2"/></svg>`,
        vegetation: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 22V12"/><path d="M12 12C12 12 7 9 7 5a5 5 0 0 1 10 0c0 4-5 7-5 7z"/><path d="M9 15c-2 1-3 3-3 3h12s-1-2-3-3"/></svg>`,
        population: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="9" cy="7" r="3"/><path d="M3 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/><circle cx="17" cy="9" r="2.5"/><path d="M21 21v-1.5a3.5 3.5 0 0 0-2.5-3.35"/></svg>`,
        parks: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="9"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><path d="M9 9h.01M15 9h.01"/></svg>`
      };
      let mapHtml = `
